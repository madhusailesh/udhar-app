...
function Navbar() {
  ...
  return (
    <nav className="relative z-50 w-full border border-gray-200 bg-white/70 p-4 shadow-lg backdrop-blur-lg transition-all duration-300 dark:border-gray-800 dark:bg-gray-900/80 dark:shadow-gray-900/50">
      ...
      <div className="flex items-center justify-between">
        ...
        <div>
          ...
          <h1 className="cursor-pointer bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-2xl font-extrabold text-transparent transition-transform duration-300 hover:scale-105">
        ...
        <div className="hidden items-center gap-6 md:flex">
          ...
          <button
            ...
            className="group flex h-10 w-10 items-center justify-center rounded-full bg-gray-100 transition-all duration-300 hover:scale-110 hover:bg-gray-200 dark:bg-gray-800 dark:hover:bg-gray-700"
        ...
        <div className="flex items-center gap-3 md:hidden">
          ...
          <button
            ...
            className="flex h-10 w-10 flex-col items-center justify-center gap-1.5 rounded-lg bg-gray-100 transition-all focus:outline-none dark:bg-gray-800"
          >
      ...
      >
        ...
        <div className="overflow-hidden">
          ...
          <div className="flex flex-col gap-4 rounded-xl border border-gray-100 bg-gray-50 p-4 dark:border-gray-700 dark:bg-gray-800/50">
